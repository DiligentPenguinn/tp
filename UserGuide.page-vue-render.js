...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Ensure you have Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed in your Computer."),_c('br'),_v(" "),_c('strong',[_v("Mac users:")]),_v(" Ensure you have the precise JDK version prescribed "),_c('a',{attrs:{"href":"https://se-education.org/guides/tutorials/javaInstallationMac.html"}},[_v("here")]),_v(".")])]),_v(" "),_c('li',[_c('p',[_v("Download the latest "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v(".jar")]),_v(" file from "),_c('a',{attrs:{"href":"https://github.com/se-edu/Klinix-level3/releases"}},[_v("here")]),_v(".")])]),_v(" "),_c('li',[_c('p',[_v("Copy the file to the folder you want to use as the "),_c('em',[_v("home folder")]),_v(" for your Klinix.")])]),_v(" "),_c('li',[_c('p',[_v("Open a command terminal, "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("cd")]),_v(" into the folder you put the jar file in, and use the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("java -jar Klinix.jar")]),_v(" command to run the application."),_c('br'),_v("\nA GUI similar to the below should appear in a few seconds. Note how the app contains some sample data."),_c('br'),_v(" "),_c('a',{attrs:{"href":"/tp/images/Ui.png","target":"_self"}},[_c('img',{staticClass:"img-fluid",attrs:{"src":"/tp/images/Ui.png","alt":"Ui"}})])])]),_v(" "),_c('li',[_c('p',[_v("Type the command in the command box and press Enter to execute it. e.g. typing "),_c('strong',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("help")])]),_v(" and pressing Enter will open the help window."),_c('br'),_v("\nSome example commands you can try:")]),_v(" "),_c('ul',[_c('li',[_c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" : Lists all contacts.")])]),_v(" "),_c('li',[_c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add ")]),_v(" : Adds a contact to Klinix.")])]),_v(" "),_c('li',[_c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 3")]),_v(" : Deletes the 3rd contact shown in the current list.")])]),_v(" "),_c('li',[_c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clear")]),_v(" : Deletes all contacts.")])]),_v(" "),_c('li',[_c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("exit")]),_v(" : Exits the app.")])]),_v(" "),_c('li',[_c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addmr")]),_v(" : Add a new medical report to a patient's record.")])]),_v(" "),_c('li',[_c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deletemr")]),_v(" : Delete a patient's existing medical report.")])]),_v(" "),_c('li',[_c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addmu")]),_v(" : Add a new medicine usage record as part of a patient’s medical history or medical needs.")])]),_v(" "),_c('li',[_c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clearmu")]),_v(" : Clear all medicine usage records of a patient's medical history.")])]),_v(" "),_c('li',[_c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deletemu")]),_v(" : Delete a particular medicine usage record of a patient's medical history.")])]),_v(" "),_c('li',[_c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addappt")]),_v(" : Add a new appointment to the patient.")])]),_v(" "),_c('li',[_c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deleteappt")]),_v(" : Delete an appointment from the patient by index.")])]),_v(" "),_c('li',[_c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clearappt")]),_v(" : Clear all appointments of a patient.")])])])]),_v(" "),_c('li',[_c('p',[_v("Refer to the "),_c('a',{attrs:{"href":"#features"}},[_v("Features")]),_v(" below for details of each command.")])])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"viewing-past-commands"}},[_v("Viewing past commands:"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#viewing-past-commands","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("You can scroll through your previously entered commands using the "),_c('strong',[_v("Up")]),_v(" and "),_c('strong',[_v("Down")]),_v(" arrow keys.")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Up Arrow")]),_v(": Scrolls to the previous command in the history.")]),_v(" "),_c('li',[_c('strong',[_v("Down Arrow")]),_v(": Scrolls to the next command in the history.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Enter a command, such as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(", and press Enter.")]),_v(" "),_c('li',[_v("Press the "),_c('strong',[_v("Up Arrow")]),_v(" key to bring up the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command in the command box.")]),_v(" "),_c('li',[_v("Press the "),_c('strong',[_v("Down Arrow")]),_v(" key to navigate back to a more recent command.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("The command history is saved only for the current session and will reset when the application is restarted.")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Format: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/NAME p/PHONE_NUMBER e/EMAIL ic/NRIC b/BIRTHDATE a/ADDRESS [t/TAG]…​")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/John Doe p/98765432 e/johnd@example.com ic/S0123456A b/10/10/2000 a/John street, block 123, #01-01")])]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/Betsy Crowe t/friend e/betsycrowe@example.com ic/S9876543B b/01/01/1990 a/Newgate Prison p/1234567 t/criminal")])])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"add-medical-report-addmr"}},[_v("Add medical report: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addmr")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#add-medical-report-addmr","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Format: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addmr ic/<NRIC> al/<Allergies> ill/<Illnesses> sur/<Surgeries> imm/<Immunizations>")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addmr ic/S1234567A al/Penicillin ill/Flu sur/Appendectomy imm/Flu Vaccine")])]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addmr ic/T0260144G al/None ill/None sur/None imm/None")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Warning:")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("The person with the given NRIC must exist, otherwise Klinix will show an error message.")]),_v(" "),_c('li',[_v("If the patient already has a medical report, adding a new one will overwrite the existing one.")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"delete-medical-report-deletemr"}},[_v("Delete medical report: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deletemr")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#delete-medical-report-deletemr","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Format: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deletemr ic/<NRIC>")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deletemr ic/S1234567A")])]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deletemr ic/T0260144G")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Warning")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("The person with the given NRIC must exist, otherwise Klinix will show an error message.")]),_v(" "),_c('li',[_v("If the patient does not have an existing medical report, nothing will happen.")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"add-medicine-usage-records-addmu"}},[_v("Add medicine usage records: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addmu")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#add-medicine-usage-records-addmu","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Format: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addmu ic/<NRIC> n/<Medicine Name> dos/<Dosage> from/<DD-MM-YYYY> to/<DD-MM-YYYY>")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addmu ic/T0260144G n/Paracetamol dos/Two 500mg tablets, 4 times in 24 hours from/2025-02-23 to/2025-02-25")])]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addmu ic/S1234567A n/Panadol Extra dos/Two 250mg tablets, once per day from/2025-03-01 to/2025-03-05")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Warning:")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("The person with the given NRIC must exist, otherwise Klinix will show an error message.")]),_v(" "),_c('li',[_v("Two medicine usage records from the same patient are overlapped if they have the same name and overlapping duration.\nKlinix will detect such overlapping instances and give an error message when you try to add them.")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"clear-all-medicine-usage-records-clearmu"}},[_v("Clear all medicine usage records: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clearmu")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#clear-all-medicine-usage-records-clearmu","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Format: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clearmu ic/<NRIC>")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("The person with the given NRIC must exist, otherwise Klinix will show an error message.")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"delete-medicine-usage-records-deletemu"}},[_v("Delete medicine usage records: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deletemu")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#delete-medicine-usage-records-deletemu","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("To be added in the next version")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"add-appointment-addappt"}},[_v("Add appointment: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addappt")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#add-appointment-addappt","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Format: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addappt ic/<NRIC> dic/<Doctor NRIC> appt/<Description> from/<DD-MM-YYYY> to/<DD-MM-YYYY>")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addappt ic/S1234567A dic/S9876543A appt/Check-up from/22-02-2025 to/23-02-2025")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Warning:")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("The person with the given NRIC must exist, otherwise Klinix will show an error message.")]),_v(" "),_c('li',[_v("Two appointments from the same patient are overlapped if they have the same name and overlapping duration.\nKlinix will detect such overlapping instances and give an error message when you try to add them.")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"delete-appointment-deleteappt"}},[_v("Delete appointment: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deleteappt")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#delete-appointment-deleteappt","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Format: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deleteappt INDEX ic/<NRIC>")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deleteappt 2 ic/S1234567A")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Warning:")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("The person with the given NRIC must exist, otherwise Klinix will show an error message.")]),_v(" "),_c('li',[_v("The index given must also be valid, a positive integer and within the appointment list size.")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"clear-all-appointment-records-clearappt"}},[_v("Clear all appointment records: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clearappt")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#clear-all-appointment-records-clearappt","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Format: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clearappt ic/<NRIC>")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("Examples: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clearappt ic/S1234567A")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Warning:")])])}
},function anonymous(
...
with(this){return _c('h3',{attrs:{"id":"delete-appointment-records-deleteappt"}},[_v("Delete appointment records: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deleteappt")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#delete-appointment-records-deleteappt","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("To be added in the next version")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"view-appointments-on-specific-date-appton"}},[_v("View appointments on specific date: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("appton")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#view-appointments-on-specific-date-appton","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Format: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("appton date/<DATE>")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("Examples: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("appton date/22-03-2025")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Klinix data are saved automatically as a JSON file "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("[JAR file location]/data/Klinix.json")]),_v(". Advanced users are welcome to update data directly by editing that data file.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Q")]),_v(": How do I transfer my data to another Computer?"),_c('br'),_v(" "),_c('strong',[_v("A")]),_v(": Install the app in the other computer and overwrite the empty data file it creates with the file that contains the data of your previous Klinix home folder.")])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Action")]),_v(" "),_c('th',[_v("Format, Examples")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('strong',[_v("Add")])]),_v(" "),_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS [t/TAG]…​")]),_v(" "),_c('br'),_v(" e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/James Ho p/22224444 e/jamesho@example.com a/123, Clementi Rd, 1234665 t/friend t/colleague")])])]),_v(" "),_c('tr',[_c('td',[_c('strong',[_v("Clear")])]),_v(" "),_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clear")])])]),_v(" "),_c('tr',[_c('td',[_c('strong',[_v("Delete")])]),_v(" "),_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete INDEX")]),_c('br'),_v(" e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 3")])])]),_v(" "),_c('tr',[_c('td',[_c('strong',[_v("Edit")])]),_v(" "),_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit INDEX [n/NAME] [p/PHONE_NUMBER] [e/EMAIL] [a/ADDRESS] [t/TAG]…​")]),_c('br'),_v(" e.g.,"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 2 n/James Lee e/jameslee@example.com")])])]),_v(" "),_c('tr',[_c('td',[_c('strong',[_v("Find")])]),_v(" "),_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find KEYWORD [MORE_KEYWORDS]")]),_c('br'),_v(" e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find James Jake")])])]),_v(" "),_c('tr',[_c('td',[_c('strong',[_v("Add Medical Report")])]),_v(" "),_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addmr ic/<NRIC> al/<Allergies> ill/<Illnesses> sur/<Surgeries> imm/<Immunizations>")]),_v(" "),_c('br'),_v(" e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addmr ic/S1234567A al/Penicillin ill/Flu sur/Appendectomy imm/Flu Vaccine")])])]),_v(" "),_c('tr',[_c('td',[_c('strong',[_v("Delete Medical Report")])]),_v(" "),_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deletemr ic/<NRIC>")]),_v(" "),_c('br'),_v(" e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deletemr ic/S1234567B")])])]),_v(" "),_c('tr',[_c('td',[_c('strong',[_v("Add Medicine Usage")])]),_v(" "),_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addmu ic/<NRIC> n/<Medicine Name> dos/<Dosage> from/<DD-MM-YYYY> to/<DD-MM-YYYY>")]),_v(" "),_c('br'),_v(" e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addmu ic/T0260144G n/Paracetamol dos/Two 500mg tablets, 4 times in 24 hours from/23-02-2025 to/25-02-2025")])])]),_v(" "),_c('tr',[_c('td',[_c('strong',[_v("Clear Medicine Usage")])]),_v(" "),_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clearmu ic/<NRIC>")]),_v(" "),_c('br'),_v(" e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clearmu ic/S1234567A")])])]),_v(" "),_c('tr',[_c('td',[_c('strong',[_v("Add Appointment")])]),_v(" "),_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addappt ic/<NRIC> dic/<Doctor NRIC> appt/<Description> from/<DD-MM-YYYY> to/<DD-MM-YYYY>")]),_v(" "),_c('br'),_v(" e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addappt ic/T0260144G dic/T9876543B appt/Check-Up from/22-02-2025 to/23-02-2025")])])]),_v(" "),_c('tr',[_c('td',[_c('strong',[_v("Delete Appointment")])]),_v(" "),_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deleteappt INDEX ic/<NRIC>")]),_v(" "),_c('br'),_v(" e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deleteappt 3 ic/S1234567A")])])]),_v(" "),_c('tr',[_c('td',[_c('strong',[_v("Clear Appointments")])]),_v(" "),_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clearappt ic/<NRIC>")]),_v(" "),_c('br'),_v(" e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clearappt ic/S1234567A")])])]),_v(" "),_c('tr',[_c('td',[_c('strong',[_v("List")])]),_v(" "),_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")])])]),_v(" "),_c('tr',[_c('td',[_c('strong',[_v("Help")])]),_v(" "),_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("help")])])]),_v(" "),_c('tr',[_c('td',[_c('strong',[_v("View Appointment on specific date")])]),_v(" "),_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("appton date/<DATE>")]),_v(" "),_c('br'),_v(" e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("appton date/22-03-2025")])])])])])])}
},function anonymous(
) {
